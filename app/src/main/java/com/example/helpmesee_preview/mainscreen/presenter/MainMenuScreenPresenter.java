package com.example.helpmesee_preview.mainscreen.presenter;
...
import com.example.helpmesee_preview.app_logic.AppState;
...
import com.example.helpmesee_preview.mainscreen.util.GpsCheckTask;
import com.example.helpmesee_preview.mainscreen.util.InternetCheckTask;
import com.example.helpmesee_preview.mainscreen.view.MainMenuScreenListener;
import com.example.helpmesee_preview.mainscreen.view.MainMenuScreenView;
import com.example.helpmesee_preview.util.ViewsFactory;

import java.util.ArrayList;
import java.util.List;

public class MainMenuScreenPresenter extends MainMenuScreenListener implements InternetCheckTask.InternetVisiter,
        GpsCheckTask.GpsVisiter {
...
//        startActivity(new Intent(MainMenuScreenPresenter.this, TextRecPresenter.class));
  ...
  public void execute(String detectedText) {
    if (detectedText.equalsIgnoreCase("EXIT")) {
      finishAffinity();
    }
  }
}
